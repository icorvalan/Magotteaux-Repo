...
namespace MGTX_arenado
{
    class ClassMGTXArenado
    {
        ...
        public void GuardadoDeDatosExcel(ExcelClass excel)
        {
            ...
            //for (int i = 0; i < DictVerticesPerimetro.Count; i++)
            //{

            //    string [] vector_info = new string[13];
            //    verticesPerimeter vp = DictVerticesPerimetro[contVertexPerimeter];
            //    string[] dataPos = g_dataMatrix[vp.fila,vp.columna].Split(';');
            //    int valueX = Convert.ToInt32(float.Parse(dataPos[0]));
            //    int valueY = Convert.ToInt32(float.Parse(dataPos[1]));
            //    string x = dataPos[0];
            //    string y = dataPos[1];
            ...
            //    vector_info[2] = "12";
            //    vector_info[3] = "0";
            //    vector_info[4] = valueX.ToString();
            //    vector_info[5] = valueY.ToString();
            //    vector_info[6] = v2;
            //    vector_info[7] = "0";
            //    double arenaNueva = Math.Round((CalculoTiempoPermanencia() * 0.3));
            //    vector_info[8] = arenaNueva.ToString();
            ...
            //    int valueX = Convert.ToInt32(float.Parse(x));
            //    int valueY = Convert.ToInt32(float.Parse(y));
            //    vector_info[1] = "SANDMIXER";
            //    vector_info[2] = "12";
            //    vector_info[3] = "0";
            //    vector_info[4] = valueX.ToString();
            ...
            //            vector_info[6] = v2;
            //            double arenaNueva = Math.Round((CalculoTiempoPermanencia() * 0.3));
            //            vector_info[7] = arenaNueva.ToString();
            //            double arenaVieja = Math.Round((CalculoTiempoPermanencia() * 0.7));
            //            vector_info[8] = arenaVieja.ToString();
