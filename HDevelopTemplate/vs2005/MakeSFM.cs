...
public partial class HDevelopExport
{
    ...
    public static decimal[] Valor_transRot = new decimal[6];
        ...
        HTuple hv_Row, HTuple hv_Column, HTuple hv_Color, HTuple hv_Box)
    {
        ...
        try
        {
            ...
            //String: A tuple of strings containing the text to be displayed
    ...
    public void Get_LecturaModelo(HTuple hv_Path, out HTuple hv_ObjectModel3D, out HTuple hv_Status,
        out HTuple hv_CentroModelo, out HTuple hv_AltoTotal, out HTuple hv_AnchoTotal,
        out HTuple hv_LargoTotal)
    {
        ...
        HTuple hv_XYZ = new HTuple(), hv_Exception = new HTuple();
        // Initialize local and output iconic variables 
        hv_ObjectModel3D = new HTuple();
        hv_Status = new HTuple();
        hv_CentroModelo = new HTuple();
        hv_AltoTotal = new HTuple();
        hv_AnchoTotal = new HTuple();
        hv_LargoTotal = new HTuple();
        try
        {
            try
            {
                ...
                HOperatorSet.ReadObjectModel3d(hv_Path, 1, new HTuple(), new HTuple(), out hv_ObjectModel3D,
                    out hv_Status);
                hv_CentroModelo.Dispose();
                HOperatorSet.GetObjectModel3dParams(hv_ObjectModel3D, "center", out hv_CentroModelo);
                hv_XYZ.Dispose();
                HOperatorSet.GetObjectModel3dParams(hv_ObjectModel3D, "bounding_box1", out hv_XYZ);
    ...
    public void Get_TipoEntidad(HTuple hv_Cod_Core_ToUse, out HTuple hv_Entidad)
    {
        ...
        try
        {
            ...
            if ((int)((new HTuple((new HTuple((new HTuple((new HTuple(hv_Entidad.TupleEqual(
                -1))).TupleAnd(new HTuple(hv_Entidad1.TupleEqual(-1))))).TupleAnd(new HTuple(hv_Entidad2.TupleEqual(
    ...
    public void Set_CentroModelo(HTuple hv_ObjectModel3D)
    {
        ...
        HTuple hv_ObjectModel3DOut = new HTuple();
        HTuple hv_X = new HTuple(), hv_Y = new HTuple(), hv_Z = new HTuple();
        HTuple hv_C = new HTuple(), hv_B = new HTuple(), hv_A = new HTuple();
        HTuple hv_WindowHandle = new HTuple(), hv_Pose = new HTuple();
        HTuple hv_Parametros_Visualizacion = new HTuple(), hv_Valores_Visualizacion = new HTuple();
        HTuple hv_PoseOut1 = new HTuple();
        // Initialize local and output iconic variables 
        try
        {
            hv_ObjectModel3DOut.Dispose();
            hv_ObjectModel3DOut = new HTuple(hv_ObjectModel3D);
            hv_X.Dispose();
            hv_X = (HTuple)Valor_transRot[0];
            hv_Y.Dispose();
            hv_Y = (HTuple)Valor_transRot[1];
            hv_Z.Dispose();
            hv_Z = (HTuple)Valor_transRot[2];
            hv_C.Dispose();
            hv_C = (HTuple)Valor_transRot[3];
            hv_B.Dispose();
            hv_B = (HTuple)Valor_transRot[4];
            hv_A.Dispose();
            hv_A = (HTuple)Valor_transRot[5];


            //dev_get_window(...);
            hv_Pose.Dispose();
            HOperatorSet.CreatePose(hv_X, hv_Y, hv_Z, hv_C, hv_B, hv_A, "Rp+T", "gba",
                "point", out hv_Pose);
            {
                HTuple ExpTmpOutVar_0;
                HOperatorSet.RigidTransObjectModel3d(hv_ObjectModel3DOut, hv_Pose, out ExpTmpOutVar_0);
                hv_ObjectModel3DOut.Dispose();
                hv_ObjectModel3DOut = ExpTmpOutVar_0;
            }
            ...
            hv_Parametros_Visualizacion[3] = "alpha";
            ...
            hv_Valores_Visualizacion[3] = 0.5;



            hv_PoseOut1.Dispose();
            visualize_object_model_3d(hv_ExpDefaultWinHandle, hv_ObjectModel3DOut, new HTuple(),
                new HTuple(), hv_Parametros_Visualizacion, hv_Valores_Visualizacion, new HTuple(),
                new HTuple(), new HTuple(), out hv_PoseOut1);


            DialogResult dialogResult = MessageBox.Show("Do you want remplace the model for this NEW translation and orientation?", "New Model 3D", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);

            if (dialogResult == DialogResult.Yes)
            {
                string[] Modelo3D = HDevelopTemplate.HDevelopTemplate.g_ruta3dModelo.Split('.');

                try
                {

                    HOperatorSet.WriteObjectModel3d(hv_ObjectModel3DOut, "stl",
                     HDevelopTemplate.HDevelopTemplate.g_ruta3dModelo,
                    new HTuple(), new HTuple());
                    MessageBox.Show("File create success!", "New Model 3D", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                catch (Exception)
                {
                    MessageBox.Show("ERROR Can't create the file", "New Model 3D", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
    ...
    public void Set_Pose(HTuple hv_ObjectModel3D, HTuple hv_Parametros_Visualizacion,
      HTuple hv_Valores_Visualizacion, HTuple hv_Sampling, HTuple hv_Modelo, HTuple hv_Index)
    {
        ...
        HTuple hv_ObjectModel3DOut = new HTuple();
        HTuple hv_CentroModelo = new HTuple(), hv_Pose = new HTuple();
        HTuple hv_PoseOut1 = new HTuple(), hv_SurfaceModelID = new HTuple();
        // Initialize local and output iconic variables 
        try
        {
            hv_ObjectModel3DOut.Dispose();
            hv_ObjectModel3DOut = new HTuple(hv_ObjectModel3D);
            hv_CentroModelo.Dispose();
            HOperatorSet.GetObjectModel3dParams(hv_ObjectModel3DOut, "center", out hv_CentroModelo);

            using (HDevDisposeHelper dh = new HDevDisposeHelper())
            {
                hv_Pose.Dispose();
                HOperatorSet.CreatePose(-(hv_CentroModelo.TupleSelect(0)), -(hv_CentroModelo.TupleSelect(
                    1)), -(hv_CentroModelo.TupleSelect(2)), 0, 0, 0, "Rp+T", "gba", "point",
                    out hv_Pose);
            }
            {
                HTuple ExpTmpOutVar_0;
            ...
            hv_Pose.Dispose();
            HOperatorSet.CreatePose(0, 0, 80, 0, 0, 0, "Rp+T", "gba", "point", out hv_Pose);
            {
                HTuple ExpTmpOutVar_0;
                HOperatorSet.RigidTransObjectModel3d(hv_ObjectModel3DOut, hv_Pose, out ExpTmpOutVar_0);
                hv_ObjectModel3DOut.Dispose();
            ...
            using (HDevDisposeHelper dh = new HDevDisposeHelper())
            {
                hv_PoseOut1.Dispose();
                visualize_object_model_3d(hv_ExpDefaultWinHandle, hv_ObjectModel3DOut, new HTuple(),
                    new HTuple(), hv_Parametros_Visualizacion.TupleConcat("alpha"), hv_Valores_Visualizacion.TupleConcat(
                    0.5), new HTuple(), new HTuple(), new HTuple(), out hv_PoseOut1);
            }
            ...
            HOperatorSet.CreateSurfaceModel(hv_ObjectModel3DOut, hv_Sampling, "train_3d_edges",
                "true", out hv_SurfaceModelID);
            using (HDevDisposeHelper dh = new HDevDisposeHelper())
            {
                HOperatorSet.WriteSurfaceModel(hv_SurfaceModelID, ((("D:/AI/Vision Artificial/4.-MAGOTTEAUX/SFM_CORES/" + (hv_Modelo.TupleSelect(
                    hv_Index))) + "/") + (hv_Modelo.TupleSelect(hv_Index))) + "_SFM");
            }
            using (HDevDisposeHelper dh = new HDevDisposeHelper())
            {
                HOperatorSet.WriteObjectModel3d(hv_ObjectModel3DOut, "stl", ((("D:/AI/Vision Artificial/4.-MAGOTTEAUX/SFM_CORES/" + (hv_Modelo.TupleSelect(
                    hv_Index))) + "/") + (hv_Modelo.TupleSelect(hv_Index))) + "_3D.stl", new HTuple(),
                    new HTuple());
            }
    ...
    public void Set_SFM(HTuple hv_ObjectModel3D, HTuple hv_Path_model)
    {
        ...
        HTuple hv_ObjectModel3DOut = new HTuple();
        HTuple hv_param = new HTuple(), hv_Valores = new HTuple();
        HTuple hv_SurfaceModelID = new HTuple();
        // Initialize local and output iconic variables 
        try
        {
            /////////////////////////////////////////////////////////////////////////////////////////////////////////////
            HTuple hv_Sampling = new HTuple(), hv_Is_a_Core = new HTuple(), hv_Modelo = new HTuple();
            hv_Sampling.Dispose();
            hv_Sampling = 0.04;
            hv_Is_a_Core.Dispose();
            var modelos3D = hv_Path_model.TupleSplit("/");
            var modelos3D_cop = modelos3D.TupleSplit(".");
            hv_Modelo = modelos3D_cop.SArr[modelos3D_cop.SArr.Length - 2];
            Get_TipoEntidad(hv_Modelo, out hv_Is_a_Core);
            ...
            hv_param.Dispose();
            hv_param = new HTuple();
            hv_param[0] = "train_3d_edges";
            hv_param[1] = "model_invert_normals";
            hv_Valores.Dispose();
            hv_Valores = new HTuple();
            hv_Valores[0] = "true";
            hv_Valores[1] = "true";
            {
                HTuple ExpTmpOutVar_0;
                HOperatorSet.SurfaceNormalsObjectModel3d(hv_ObjectModel3DOut, "mls", new HTuple(),
                    new HTuple(), out ExpTmpOutVar_0);
                hv_ObjectModel3DOut.Dispose();
                hv_ObjectModel3DOut = ExpTmpOutVar_0;
            }
            hv_SurfaceModelID.Dispose();
            HOperatorSet.CreateSurfaceModel(hv_ObjectModel3DOut, hv_Sampling, hv_param, hv_Valores,
                out hv_SurfaceModelID);

            HTuple NewPath_SFM = new HTuple();
            string Aux = "";
            for (int i = 0; i < modelos3D_cop.Length - 3; i++)
            {
                Aux = Aux + modelos3D.SArr[i] + "/";
            }

            string RutaSFM = Aux + modelos3D_cop.SArr[modelos3D_cop.Length - 3] + "_SFM.sfm";
            string Ruta3D = Aux + modelos3D_cop.SArr[modelos3D_cop.Length - 3] + "_3D.stl";
            ...
            try
            {
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    HOperatorSet.WriteSurfaceModel(hv_SurfaceModelID, (HTuple)RutaSFM);
                }
      
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    HOperatorSet.WriteObjectModel3d(hv_ObjectModel3DOut, "stl", Ruta3D,
                        new HTuple(), new HTuple());
                }

                HOperatorSet.ClearSurfaceModel(hv_SurfaceModelID);
                MessageBox.Show("SFM File Created", "New Model 3D", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            ...
            catch (Exception error)
            {
                ...
                MessageBox.Show("### ERROR###\nIs not posible wtite the SURFACE MODEL","Error",MessageBoxButtons.OK,MessageBoxIcon.Error);
            }
    ...
    public void Ver_modelo3d(HTuple hv_Path)
    {
        ...
        HTuple hv_WindowHandle = new HTuple(), hv_Parametros_Visualizacion = new HTuple();
        HTuple hv_Valores_Visualizacion = new HTuple(), hv_ObjectModel3D = new HTuple();
        HTuple hv_Status = new HTuple(), hv_CentroModelo = new HTuple();
        HTuple hv_XYZ = new HTuple(), hv_AltoTotal = new HTuple();
        HTuple hv_AnchoTotal = new HTuple(), hv_LargoTotal = new HTuple();
        HTuple hv_PoseOut1 = new HTuple();
        // Initialize local and output iconic variables 
        try
        {
            ...
            hv_ObjectModel3D.Dispose(); hv_Status.Dispose(); hv_CentroModelo.Dispose(); hv_AltoTotal.Dispose(); hv_AnchoTotal.Dispose(); hv_LargoTotal.Dispose();
            Get_LecturaModelo(hv_Path, out hv_ObjectModel3D, out hv_Status, out hv_CentroModelo,
                out hv_AltoTotal, out hv_AnchoTotal, out hv_LargoTotal);
    ...
    public void Mover_modelo_3D(HTuple hv_Path)
    {
        ...
        HTuple hv_LargoTotal = new HTuple(), hv_PoseOut1 = new HTuple();

        hv_ObjectModel3D.Dispose(); hv_Status.Dispose(); hv_CentroModelo.Dispose(); hv_AltoTotal.Dispose(); hv_AnchoTotal.Dispose(); hv_LargoTotal.Dispose();
        Get_LecturaModelo(hv_Path, out hv_ObjectModel3D, out hv_Status, out hv_CentroModelo,
            out hv_AltoTotal, out hv_AnchoTotal, out hv_LargoTotal);

        Set_CentroModelo(hv_ObjectModel3D);
    ...
    private void action()
    {
        ...
        HTuple hv_WindowHandle = new HTuple(), hv_Cores = new HTuple();
        HTuple hv_Modelo = new HTuple(), hv_Parametros_Visualizacion = new HTuple();
        HTuple hv_Valores_Visualizacion = new HTuple(), hv_Index = new HTuple();
        HTuple hv_Path = new HTuple(), hv_ObjectModel3D = new HTuple();
        HTuple hv_Status = new HTuple(), hv_CentroModelo = new HTuple();
        HTuple hv_XYZ = new HTuple(), hv_AltoTotal = new HTuple();
        HTuple hv_AnchoTotal = new HTuple(), hv_LargoTotal = new HTuple();
        HTuple hv_VerModelo3D = new HTuple(), hv_PoseOut1 = new HTuple();
        HTuple hv_X = new HTuple(), hv_Y = new HTuple(), hv_Z = new HTuple();
        HTuple hv_C = new HTuple(), hv_B = new HTuple(), hv_A = new HTuple();
        HTuple hv_Pose = new HTuple(), hv_MakeSfm = new HTuple();
        HTuple hv_Sampling = new HTuple(), hv_Is_a_Core = new HTuple();
        // Initialize local and output iconic variables 
        try
        {
      ...
      for (hv_Index=0; (int)hv_Index<=(int)((new HTuple(hv_Modelo.TupleLength()))-1); hv_Index = (int)hv_Index + 1)
      {

        hv_Path.Dispose();
        using (HDevDisposeHelper dh = new HDevDisposeHelper())
        {
        hv_Path = ((("D:/AI/Vision Artificial/4.-MAGOTTEAUX/SFM_Cores/"+(hv_Modelo.TupleSelect( hv_Index)))+"/")+(hv_Modelo.TupleSelect(hv_Index)))+"_3D.stl";
        }



        hv_ObjectModel3D.Dispose();hv_Status.Dispose();hv_CentroModelo.Dispose();hv_XYZ.Dispose();hv_AltoTotal.Dispose();hv_AnchoTotal.Dispose();hv_LargoTotal.Dispose();

        Get_LecturaModelo(hv_Path, 
		out hv_ObjectModel3D, out hv_Status, out hv_CentroModelo,out hv_XYZ, out hv_AltoTotal, out hv_AnchoTotal, out hv_LargoTotal);


        hv_VerModelo3D.Dispose();
        hv_VerModelo3D = 0;
        if ((int)(hv_VerModelo3D) != 0)
        {
          using (HDevDisposeHelper dh = new HDevDisposeHelper())
          {
          hv_PoseOut1.Dispose();
          visualize_object_model_3d(hv_ExpDefaultWinHandle, hv_ObjectModel3D, new HTuple(), 
              ...
              hv_Modelo.TupleSelect(hv_Index), new HTuple(), new HTuple(), out hv_PoseOut1);
          }
        }

        hv_X.Dispose();hv_Y.Dispose();hv_Z.Dispose();hv_C.Dispose();hv_B.Dispose();hv_A.Dispose();hv_WindowHandle.Dispose();hv_Pose.Dispose();
        {
        HTuple ExpTmpOutVar_0;
        Set_CentroModelo(hv_ObjectModel3D, hv_Parametros_Visualizacion, hv_Valores_Visualizacion, 
            hv_Modelo, hv_Index, out hv_X, out hv_Y, out hv_Z, out hv_C, out hv_B, 
            out hv_A, out hv_WindowHandle, out hv_Pose, out ExpTmpOutVar_0);
        hv_ObjectModel3D.Dispose();
        ...
        {
        hv_Is_a_Core.Dispose();
        Get_TipoEntidad(hv_Modelo.TupleSelect(hv_Index), out hv_Is_a_Core);
        }
        if ((int)(hv_Is_a_Core.TupleNot()) != 0)
        {
          hv_Sampling.Dispose();
        ...
        hv_PoseOut1.Dispose();
        HOperatorSet.CreatePose(0, 0, 2850, 0, 0, 0, "Rp+T", "gba", "point", out hv_PoseOut1);
        HOperatorSet.DispObjectModel3d(hv_ExpDefaultWinHandle, hv_ObjectModel3D, 
            new HTuple(), hv_PoseOut1, hv_Parametros_Visualizacion, hv_Valores_Visualizacion);


        if ((int)(hv_MakeSfm) != 0)
        {
          Set_SFM(hv_ObjectModel3D, hv_Sampling, hv_Modelo, hv_Index);
        }
      ...
      throw new HalconException("Creación Finalizada");
            */
        }
        catch (HalconException HDevExpDefaultException)
        {
    ...
    public void VerModelos3ds(HTuple Window, HTuple Path)
    {
        hv_ExpDefaultWinHandle = Window;
        Ver_modelo3d(Path);
    }

    public void Move_model_3d(HTuple Window, HTuple hv_Path)
    {
        hv_ExpDefaultWinHandle = Window;

        Mover_modelo_3D(hv_Path);

    }

    public static bool showFromLoad = false;
    public void MakeSFM_Model(HTuple hv_Path)
    {
        // Local iconic variables 
        ...
        try
        {
            ...
            hv_PoseOut1.Dispose();
            MessageBox.Show("Please Chech de 3D Visor", "3D model", MessageBoxButtons.OK, MessageBoxIcon.Information);
            visualize_object_model_3d(hv_ExpDefaultWinHandle, hv_ObjectModel3D, new HTuple(),
                new HTuple(), hv_Parametros_Visualizacion, hv_Valores_Visualizacion, new HTuple(),
                new HTuple(), new HTuple(), out hv_PoseOut1);
            ...
            /////////////////////////////////////////////////////////////////////////////////////
            Set_SFM(hv_ObjectModel3D, hv_Path);
            ////////////////////////////////////////////////////////////////////////////////////
