...
public partial class HDevelopExport
{
  ...
  public void Get_Cores (out HTuple hv_Cores)
  {
    ...
    {
      hv_Archivos.Dispose();
      HOperatorSet.ListFiles("C:/SFM_Cores", "directories", out hv_Archivos);
  ...
  public void Set_CentroModelo (HTuple hv_ObjectModel3D)
  {
    ...
    try
    {
      ...
      HOperatorSet.WriteObjectModel3d(hv_ObjectModel3DOut, "stl", "PATH AL MODELO 3D", 
      ...
      HTuple hv_Valores_Visualizacion, HTuple hv_Sampling, HTuple hv_Modelo, HTuple hv_Index)
  {
    ...
    try
    {
      ...
      //create_pose (0, 0, 0, 0, -90, 0, 'Rp+T', 'gba', 'point', Pose)
      //rigid_trans_object_model_3d (ObjectModel3DOut, Pose, ObjectModel3DOut)

      //create_pose (0, 0, 0, 0, 0, 20, 'Rp+T', 'gba', 'point', Pose)
      //rigid_trans_object_model_3d (ObjectModel3DOut, Pose, ObjectModel3DOut)


      //create_pose (0, -2, 0, 0, 0, 0, 'Rp+T', 'gba', 'point', Pose)
      //rigid_trans_object_model_3d (ObjectModel3DOut, Pose, ObjectModel3DOut)
  ...
  public void Set_SFM (HTuple hv_ObjectModel3D, HTuple hv_Path_model)
  {
    ...
    try
    {
      ...
      hv_SurfaceModelID.Dispose();
      HOperatorSet.CreateSurfaceModel(hv_ObjectModel3DOut, 0.9999999, hv_param, hv_Valores, 
          out hv_SurfaceModelID);


      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      HOperatorSet.WriteSurfaceModel(hv_SurfaceModelID, new HTuple("D:/AI/Vision Artificial/4.-MAGOTTEAUX/SFM_CORES/")+"_SFM");
      }
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      HOperatorSet.WriteObjectModel3d(hv_ObjectModel3DOut, "stl", new HTuple("D:/AI/Vision Artificial/4.-MAGOTTEAUX/SFM_CORES/")+"_3D.stl", 
          new HTuple(), new HTuple());
      }
  ...
  private void action()
  {
    ...
    HTuple hv_Parametros_Visualizacion = new HTuple(), hv_Valores_Visualizacion = new HTuple();
    HTuple hv_Modelo = new HTuple(), hv_Index = new HTuple();
    HTuple hv_Path = new HTuple(), hv_ObjectModel3D = new HTuple();
    HTuple hv_Status = new HTuple(), hv_CentroModelo = new HTuple();
    HTuple hv_AltoTotal = new HTuple(), hv_AnchoTotal = new HTuple();
    HTuple hv_LargoTotal = new HTuple(), hv_VerModelo3D = new HTuple();
    HTuple hv_MakeSfm = new HTuple(), hv_Sampling = new HTuple();
    HTuple hv_Is_a_Core = new HTuple(), hv_pahtModel = new HTuple();
    // Initialize local and output iconic variables 
    try
    {
      ...
      for (hv_Index=0; (int)hv_Index<=(int)((new HTuple(hv_Modelo.TupleLength()))-1); hv_Index = (int)hv_Index + 1)
      {
        ...
        using (HDevDisposeHelper dh = new HDevDisposeHelper())
        {
        hv_Path = ((("C:/SFM_Cores/"+(hv_Modelo.TupleSelect(
            hv_Index)))+"/")+(hv_Modelo.TupleSelect(hv_Index)))+"_3D.stl";
        }
        ...
        if ((int)(hv_MakeSfm) != 0)
        {
          hv_pahtModel.Dispose();
          hv_pahtModel = "";

          Set_SFM(hv_ObjectModel3D, hv_pahtModel);
        }
        //*********************************************************************
